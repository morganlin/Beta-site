...
extern void ac97_codec_reset(void);
extern void ac97_codec_init(void);
extern void ac97_interface_enable(void);
extern void ac97_pcm_codec_init(void);
...
{
//printf("%s: val 0x%08X, reg 0x%08X\n", __func__, val, socle_i2s_base + reg);
...
static u32 frequecy_setting = SOCLE_I2S_OVERSAMPLING_RATE_64 | SOCLE_I2S_RATIO(12);	/* default */
//static u32 frequecy_setting = SOCLE_I2S_OVERSAMPLING_RATE_64 | SOCLE_I2S_RATIO(24);	/*AC97*/
#else	//mosa 6335
...
socle_i2s_normal_internal_loopback(autotest)
{
	...
	memset((char *)socle_i2s_pattern_buf, 0x0, PATTERN_BUF_SIZE);
	memset((char *)socle_i2s_cmpr_buf, 0x0, PATTERN_BUF_SIZE);
...
socle_i2s_hwdma_panther7_hdma_direct(int autotest)
{
	...
	/* Clear pattern buffer and compare buffer */
	memset((char *)socle_i2s_pcm_buf, 0x00, DMA_BUF_SIZE);
	memset((char *)socle_i2s_dma_buf, 0x00, DMA_BUF_SIZE);
...
socle_i2s_play_pcm_normal(int autotest)
{
	...
	socle_i2s_write(
			...
			SOCLE_I2S_TXCTL);
#if 0
	socle_i2s_write(0, SOCLE_I2S_RXCTL);
#endif
...
socle_i2s_capture_pcm_normal(int autotest)
{
	...
	socle_i2s_write(
			...
			SOCLE_I2S_RXCTL);
#if 1
	socle_i2s_write(0, SOCLE_I2S_TXCTL);
#endif
