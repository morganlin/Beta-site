...
#define		RXWAIT_CLOCK			0x10000				// wait *2ms
...
extern struct test_item_container mac_mode_container;
...
int mac_1_test(int autotest)
{
	int ret=0;
	mac_reg_base = MAC_REG_BASE_1;
	mac_int = MAC_INT_1;
