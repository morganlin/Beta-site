...
#define	INTC1_SCR(x) ((addr_t)(SOCLE_INTC1 + 4 * (x)))
#define	INTC1_SVR(x) ((addr_t)(SOCLE_INTC1 + 0x80	+ 4 * (x)))
#define	INTC1_ISR    ((addr_t)(SOCLE_INTC1 + 0x104))
#define	INTC1_IPR    ((addr_t)(SOCLE_INTC1 + 0x108))
#define	INTC1_IMR    ((addr_t)(SOCLE_INTC1 + 0x10C))
#define	INTC1_IECR   ((addr_t)(SOCLE_INTC1 + 0x114))
#define	INTC1_ICCR   ((addr_t)(SOCLE_INTC1 + 0x118))
#define	INTC1_ISCR   ((addr_t)(SOCLE_INTC1 + 0x11C))
//#define	INTC1_EOICR  ((addr_t)(SOCLE_INTC1 + 0x120))
#define	INTC1_TEST   ((addr_t)(SOCLE_INTC1 + 0x124))
...
#define	INTC0_SCR(x) ((addr_t)(SOCLE_INTC1 + 4 * (x)))
#define	INTC0_SVR(x) ((addr_t)(SOCLE_INTC1 + 0x80	+ 4 * (x)))
#define	INTC0_ISR    ((addr_t)(SOCLE_INTC1 + 0x104))
#define	INTC0_IPR    ((addr_t)(SOCLE_INTC1 + 0x108))
#define	INTC0_IMR    ((addr_t)(SOCLE_INTC1 + 0x10C))
#define	INTC0_IECR   ((addr_t)(SOCLE_INTC1 + 0x114))
#define	INTC0_ICCR   ((addr_t)(SOCLE_INTC1 + 0x118))
#define	INTC0_ISCR   ((addr_t)(SOCLE_INTC1 + 0x11C))
//#define	INTC1_EOICR  ((addr_t)(SOCLE_INTC1 + 0x120))
#define	INTC0_TEST   ((addr_t)(SOCLE_INTC1 + 0x124))
