...
extern int panther7_hdma_channel_2_test(int autotest);
extern int panther7_hdma_channel_3_test(int autotest);
...
struct test_item panther7_hdma_ch_items[] = {
	...
	{"Channel 1",
	 ...
	 1},
	{"Channel 2",
	 panther7_hdma_channel_2_test,
	 1,
	 PANTHER7_HDMA1_TEST},
	{"Channel 3",
	 panther7_hdma_channel_3_test,
	 1,
	 PANTHER7_HDMA1_TEST}
};
